...
class AxilioApi:
    ...
    environment : AxilioApiEnvironment
        The environment to use for requests from the client. from .environment import AxilioApiEnvironment



        Defaults to AxilioApiEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: AxilioApiEnvironment = AxilioApiEnvironment.DEFAULT,
        api_key: str,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: AxilioApiEnvironment) -> str:
