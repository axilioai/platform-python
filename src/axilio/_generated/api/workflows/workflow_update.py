...
from ...models.workflow_workflow_update_request import WorkflowWorkflowUpdateRequest
...
def _get_kwargs(
    workflow_id: str,
    *,
    body: WorkflowWorkflowUpdateRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update a workflow
     ...
     Applies a partial update (name, platform, status, ocr_engine). Org-scoped — workflows in other orgs
    return 404.
