...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/phones/{phone_id}/interaction".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Record a user interaction timestamp

     Bumps the device's last_interaction_timestamp. Powers the idle-timeout cron and the dashboard's
    \"last active\" column.
