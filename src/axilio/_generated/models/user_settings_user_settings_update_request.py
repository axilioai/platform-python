...
T = TypeVar("T", bound="UserSettingsUserSettingsUpdateRequest")


@_attrs_define
class UserSettingsUserSettingsUpdateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_settings_user_settings_update_request = cls(
            schema=schema,
            claude_api_key=claude_api_key,
            openai_api_key=openai_api_key,
        )

        return user_settings_user_settings_update_request
