...
if TYPE_CHECKING:
    from ..models.v2_error_detail import V2ErrorDetail


T = TypeVar("T", bound="V2ErrorModel")
...
class V2ErrorModel:
    ...
    Attributes:
        ...
        errors (list[V2ErrorDetail] | None | Unset): Optional list of individual error details
    ...
    errors: list[V2ErrorDetail] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_errors(data: object) -> list[V2ErrorDetail] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for errors_type_0_item_data in _errors_type_0:
                    errors_type_0_item = V2ErrorDetail.from_dict(errors_type_0_item_data)
                ...
                pass
            return cast(list[V2ErrorDetail] | None | Unset, data)
