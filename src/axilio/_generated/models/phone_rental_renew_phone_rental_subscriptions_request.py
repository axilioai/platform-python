...
T = TypeVar("T", bound="PhoneRentalRenewPhoneRentalSubscriptionsRequest")


@_attrs_define
class PhoneRentalRenewPhoneRentalSubscriptionsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        phone_rental_renew_phone_rental_subscriptions_request = cls(
            subscription_ids=subscription_ids,
            schema=schema,
        )

        return phone_rental_renew_phone_rental_subscriptions_request
