...
class RawUserClient:
    ...
    def get_me(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[UserUserResponse]:
        """
...
class AsyncRawUserClient:
    ...
    ) -> AsyncHttpResponse[UserUserResponse]:
        """
        Returns the authenticated user's profile (id, email, verified/admin flags, timestamps).
